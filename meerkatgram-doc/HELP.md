...
* [Spring Configuration Processor](https://docs.spring.io/spring-boot/3.5.15-SNAPSHOT/specification/configuration-metadata/annotation-processor.html)
* [JDBC API](https://docs.spring.io/spring-boot/3.5.15-SNAPSHOT/reference/data/sql.html)
